            ...
            if(mNPCObject)
            {
                switch(mSecondaryClass)
                {
                    ...
                    case Classification.Fist:
                        if (critChance <= mSecondaryCriticalChance + mNPCObject.GetWeaponSkills().GetFistStats().GetCriticalChanceBonus())
                        {
                            totalDamage.SetAmount((mSecondaryDamage.GetAmount() + mNPCObject.GetWeaponSkills().GetFistStats().GetDamageBonus()) * mSecondaryCriticalMultiplier);
                        }
                        else
                        {
                            totalDamage.SetAmount(mSecondaryDamage.GetAmount() + mNPCObject.GetWeaponSkills().GetFistStats().GetDamageBonus());
                        }
                        break;
            ...
            else if(mPlayerObject)
            {
                switch (mSecondaryClass)
                {
                    ...
                    case Classification.TwoHandedSword:
                        ...
                        break;
                    case Classification.Fist:
                        if (critChance <= mSecondaryCriticalChance + mPlayerObject.GetWeaponSkills().GetFistStats().GetCriticalChanceBonus())
                        {
                            totalDamage.SetAmount((mSecondaryDamage.GetAmount() + mPlayerObject.GetWeaponSkills().GetFistStats().GetDamageBonus()) * mSecondaryCriticalMultiplier);
                        }
                        else
                        {
                            totalDamage.SetAmount(mSecondaryDamage.GetAmount() + mPlayerObject.GetWeaponSkills().GetFistStats().GetDamageBonus());
                        }
                        break;
                    case Classification.Wand:
            ...
            if (mNPCObject)
            {
                switch (mSecondaryClass)
                {
                    ...
                    case Classification.TwoHandedSword:
                        ...
                        break;
                    case Classification.Fist:
                        if (hitChance > mSecondaryAccuracy + mNPCObject.GetWeaponSkills().GetFistStats().GetAccuracyBonus())
                        {
                            totalDamage.SetAmount(0.0f);
                        }
                        break;
            ...
            else if (mPlayerObject)
            {
                switch (mSecondaryClass)
                {
                    ...
                    case Classification.TwoHandedSword:
                        ...
                        break;
                    case Classification.Fist:
                        if (hitChance > mSecondaryAccuracy + mPlayerObject.GetWeaponSkills().GetFistStats().GetAccuracyBonus())
                        {
                            totalDamage.SetAmount(0.0f);
                        }
                        break;
            ...
            if (mNPCObject)
            {
                switch (mMainClass)
                {
                    ...
                    case Classification.TwoHandedSword:
                        ...
                        break;
                    case Classification.Fist:
                        if (critChance <= mMainCriticalChance + mNPCObject.GetWeaponSkills().GetFistStats().GetCriticalChanceBonus())
                        {
                            totalDamage.SetAmount((mMainDamage.GetAmount() + mNPCObject.GetWeaponSkills().GetFistStats().GetDamageBonus()) * mMainCriticalMultiplier);
                        }
                        else
                        {
                            totalDamage.SetAmount(mMainDamage.GetAmount() + mNPCObject.GetWeaponSkills().GetFistStats().GetDamageBonus());
                        }
                        break;
                    case Classification.Wand:
            ...
            else if (mPlayerObject)
            {
                switch (mMainClass)
                {
                    ...
                    case Classification.TwoHandedSword:
                        ...
                        break;
                    case Classification.Fist:
                        if (critChance <= mMainCriticalChance + mPlayerObject.GetWeaponSkills().GetFistStats().GetCriticalChanceBonus())
                        {
                            totalDamage.SetAmount((mMainDamage.GetAmount() + mPlayerObject.GetWeaponSkills().GetFistStats().GetDamageBonus()) * mMainCriticalMultiplier);
                        }
                        else
                        {
                            totalDamage.SetAmount(mMainDamage.GetAmount() + mPlayerObject.GetWeaponSkills().GetFistStats().GetDamageBonus());
                        }
                        break;
                    case Classification.Wand:
            ...
            if (mNPCObject)
            {
                switch (mMainClass)
                {
                    ...
                    case Classification.TwoHandedSword:
                        ...
                        break;
                    case Classification.Fist:
                        if (hitChance > mMainAccuracy + mNPCObject.GetWeaponSkills().GetFistStats().GetAccuracyBonus())
                        {
                            totalDamage.SetAmount(0.0f);
                        }
                        break;
            ...
            else if (mPlayerObject)
            {
                switch (mMainClass)
                {
                    ...
                    case Classification.TwoHandedSword:
                        ...
                        break;
                    case Classification.Fist:
                        if (hitChance > mMainAccuracy + mPlayerObject.GetWeaponSkills().GetFistStats().GetAccuracyBonus())
                        {
                            totalDamage.SetAmount(0.0f);
                        }
                        break;
            ...
            if(mNPCObject)
            {
                switch (mSecondaryClass)
                {
                    ...
                    case Classification.TwoHandedSword:
                        ...
                        break;
                    case Classification.Fist:
                        totalSpeed += mNPCObject.GetWeaponSkills().GetFistStats().GetSpeedBonus();
                        break;
                    case Classification.Wand:
            ...
            else if(mPlayerObject)
            {
                switch (mSecondaryClass)
                {
                    ...
                    case Classification.TwoHandedSword:
                        ...
                        break;
                    case Classification.Fist:
                        totalSpeed += mPlayerObject.GetWeaponSkills().GetFistStats().GetSpeedBonus();
                        break;
                    case Classification.Wand:
